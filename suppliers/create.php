        ...
        <div class="p-8">
            ...
            <div class="max-w-2xl bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                ...
                <div class="mb-8 border-b border-gray-100 pb-4">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Lengkapi form di bawah ini untuk menambahkan data relasi pemasok barang.</p>
                </div>
                ...
                <form action="store.php" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input
                            type="text"
                            name="name"
                            placeholder="Contoh: PT. Maju Jaya atau Toko Sentosa"
                    ...
                    <div class="mb-8">
                        ...
                        <textarea
                            ...
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 bg-gray-50 focus:bg-white"></textarea>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        <button
                            ...
                            <!-- Ikon Centang (Sudah dikunci ukurannya) -->
