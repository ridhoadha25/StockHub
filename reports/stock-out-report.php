        ...
        <div class="p-8">
            ...
            <div class="flex justify-between items-center mb-6 print:hidden">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Rekapitulasi seluruh transaksi pengeluaran stok barang.</p>
                </div>
                <button onclick="window.print()" class="bg-red-600 hover:bg-red-700 text-white font-semibold px-5 py-2.5 rounded-lg shadow-sm transition duration-200 flex items-center gap-2">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden print:shadow-none print:border-none print:rounded-none">
                ...
                <div class="hidden print:block text-center mb-6 border-b-2 border-gray-800 pb-4">
                    <h2 class="text-2xl font-bold uppercase tracking-wider">Laporan Barang Keluar</h2>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 print:divide-gray-300">
                            ...
                            <tr class="hover:bg-gray-50 transition duration-150">
                                ...
                                <td class="px-6 py-4 text-sm text-center font-bold text-red-600 print:text-black">
                                    -<?= $row['quantity']; ?>
                                </td>
